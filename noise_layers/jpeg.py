...
class Random_Jpeg_combined(nn.Module):
	def __init__(self):
		super(Random_Jpeg_combined, self).__init__()
		self.noise_list = [RandomJpegSS(), RandomJpegMask()]
	...
	def forward(self, noised_and_cover):
		...
		return self.noise_list[id](n_a_c)